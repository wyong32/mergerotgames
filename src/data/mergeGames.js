export const mergeGamesData = {
  gamesList: [
    {
      id: 1,
      title: 'Brainrot Clicker', // 游戏名称
      time: '2025-06-27', // 游戏时间
      addressBar: 'brainrot-clicker', // 游戏地址栏
      seo: {
        title: 'Merge Rot: Classic - Official Game Page',
        description: 'Play Merge Rot: Classic, the original strategic merge game. Learn the rules, master the board, and aim for the ultimate merge.',
        keywords: 'merge rot, classic, puzzle game, strategy, merge'
      },
      category: ['italian-brainrot-games'], // merge-games, italian-brainrot-games
      imageUrl: '/images/game-01.webp', // 游戏图片
      imageAlt: 'Brainrot Clicker – The Ultimate Meme Idle Game', // 游戏图片alt
      iframeUrl: 'https://1games.io/game/tralalero-tralala-clicker/', // 游戏iframe地址
      isHome: true, // 是否显示在热门
  ...
  <ul>
    <li>Click to earn brainrot energy</li>
    <li>Unlock upgrades that automate clicks and spawn chaos</li>
    <li>Watch your screen fill with escalating insanity</li>
  ...
  <ul>
    ...
    <li><strong>Endless Upgrades:</strong> Unlock new backgrounds, sounds, and power-ups as your influence grows</li>
    <li><strong>Mobile-Friendly:</strong> Fully browser-based with responsive design for phones, tablets, and desktops</li>
  ...
  <ol>
    ...
    <li><strong>Embrace the Madness:</strong> Don't worry about logic—Brainrot Clicker is all about entertainment.</li>
  ...
  <p>Absolutely! Brainrot Clicker is 100% free to play and doesn't require any registration.</p>
...

    {
      ...
      seo: {
        title: 'Merge Brainrot - Chaotic Merge Madness Game Online',
        description: 'Play Merge Brainrot, the ultimate fusion of meme chaos and merge strategy. Merge bizarre units, unlock unhinged upgrades, and conquer the brainrot board.',
        keywords: 'merge brainrot, brainrot game, merge game, meme merge, strategy puzzle, idle merge'
      },
      category: ['merge-games', 'italian-brainrot-games'],
      imageUrl: '/images/game-02.webp',
      imageAlt: 'Merge Brainrot – Dive Into the Ultimate Meme Merge Game',
      ...
      <ul>
        <li>Drag and drop to merge identical units in <strong>Merge Brainrot</strong></li>
        <li>Unlock increasingly unhinged meme creatures</li>
        <li>Generate brainrot energy to buy generators and boosts</li>
      ...
      <ul>
        ...
        <li><strong>Strategic Depth:</strong> Planning merges and placements is key to mastering <strong>Merge Brainrot</strong></li>
        <li><strong>Sound Chaos:</strong> Every merge triggers ridiculous audio—from airhorns to opera screams</li>
      ...
      <ol>
        ...
        <li><strong>Focus on Rare Units:</strong> Higher-tier memes in <strong>Merge Brainrot</strong> unlock special effects and boosts.</li>
        <li><strong>Use Brainrot Energy Efficiently:</strong> Spend energy on automation tools and high-level generators.</li>
...

    {
      ...
      seo: {
        title: 'Merge Fellas Italian Brainrot - Chaotic Merge Game of Pure Italian Madness',
      ...
      <ul>
        <li>Merge fellas like "Tiny Tony" and "Spicy Gino"</li>
        <li>Unlock Nonna-powered boosters</li>
        <li>Trigger chaos combos with opera sound FX</li>
      ...
      <ul>
        ...
        <li><strong>Offline Chaos:</strong> Keep earning pasta even when you're asleep</li>
        <li><strong>Mobile-Friendly:</strong> <strong>Merge Fellas Italian Brainrot</strong> plays perfectly on phones, tablets, and sauce-stained laptops</li>
      ...
      <ol>
        ...
        <li><strong>Tap for Espresso Energy:</strong> Speed up your merges during Fella Frenzy</li>
        <li><strong>Prestige Regularly:</strong> Rebirth into more chaotic timelines</li>
...

    {
      ...
      title: 'Merge Fruit',
      time: '2025-06-30',
      addressBar: 'merge-fruit',
      seo: {
        title: 'Merge Fruit - Sweet and Juicy Merge Puzzle Game',
        description: 'Play Merge Fruit, the fun and addictive merge puzzle game where you combine fruits to create sweet combos. Unlock new fruit varieties and grow your juicy empire!',
        keywords: 'merge fruit, fruit puzzle, merge game, juicy fruits, casual puzzle, fun merge game'
      },
      category: ['merge-games'],
      imageUrl: '/images/game-04.webp',
      imageAlt: 'Merge Fruit – A Sweet, Juicy Merge Puzzle Game',
      iframeUrl: 'https://mergefruits.io/',
      isHome: true,
      isFella: true,
      isDetails: false,
      detailsHtml: `
      ...
      <ul>
        <li>Start with basic fruits like apples, oranges, and bananas</li>
        <li>Merge two matching fruits to create a new, higher-tier fruit</li>
        <li>Unlock exotic fruits as you level up</li>
      ...
      <ul>
        ...
        <li><strong>Multiple Fruit Tiers:</strong> From apples to exotic tropical fruits, there are many fun merges to discover</li>
        <li><strong>Casual, Yet Addictive:</strong> It's easy to start, but hard to stop once you're hooked on unlocking more fruit combos</li>
      ...
      <ol>
        ...
        <li><strong>Focus on Higher-Tier Fruits:</strong> Aim to merge into more exotic fruits to unlock even more exciting combos!</li>
        <li><strong>Use Your Coins Wisely:</strong> Spend coins on boosts or unlocking special fruit varieties to get ahead.</li>
    ...
    {
      id: 5,
      title: 'Merge Brainrot2',
      time: '2025-07-01',
      addressBar: 'merge-brainrot2',
      seo: {
        title: 'Merge Brainrot - Absurd Meme Merge Game Online',
        description: 'Play Merge Brainrot, the chaotic merge puzzle game filled with brainrot energy, meme characters, and infinite absurdity. Tap, merge, and descend into madness.',
        keywords: 'merge brainrot, meme merge game, brainrot puzzle, absurd idle merge, chaotic merge game'
      },
      category: ['merge-games'],
      imageUrl: '/images/game-05.webp',
      imageAlt: 'Merge Brainrot – The Ultimate Meme Merge Game',
      iframeUrl: 'https://html5.gamedistribution.com/ea08335b6c9043e7a2403f6d5e8d1664/?gd_sdk_referrer_url=https%3A%2F%2Fwww.twoplayergames.org%2Fgame%2Fmerge-brainrot',
      isHome: true,
      isFella: true,
      isDetails: false,
      detailsHtml: `
      ...
      <ul>
        <li>Drag and drop to merge identical brainrot units</li>
        <li>Unlock new characters like screaming toast, sad cloud dogs, and sentient capybaras</li>
        <li>Fill your board with chaos and generate brainrot points</li>
      ...
      <ul>
        ...
        <li><strong>Offline Progress:</strong> <strong>Merge Brainrot</strong> keeps earning points even while you sleep (or cry)</li>
        <li><strong>Cross-Platform Chaos:</strong> Play <strong>Merge Brainrot</strong> on desktop, tablet, or your grandma's smart fridge</li>
      ...
      <ol>
        ...
        <li><strong>Focus on High-Tier Units:</strong> They produce exponentially more brainrot energy</li>
        <li><strong>Use Boosters:</strong> Especially during events like "Meme Storm" or "Capybara Carnival"</li>
    ...
    
    {
      ...
      time: '2025-06-30',
      addressBar: 'watermelon-game',
      seo: {
        title: 'Watermelon Game - Fun and Refreshing Merge Puzzle Online',
        description: 'Play Watermelon Game, the relaxing merge puzzle where fruits collide and become juicy surprises. Easy to play, hard to stop!',
        keywords: 'watermelon game, fruit merge game, casual puzzle, relaxing game, fun merge game'
      },
      category: ['merge-games'],
      imageUrl: '/images/game-06.webp',
      imageAlt: 'Watermelon Game – A Fresh and Juicy Merge Puzzle',
      iframeUrl: 'https://watermelon-game.games.playgama.com/cm5wnkcmd000syg0emwt097b0/index.html?platform_id=playgama',
      isHome: true,
      isFella: true,
      isDetails: true,
      detailsHtml: `
      ...
      <ul>
        <li>Tap or click to drop a fruit from the top of the screen</li>
        <li>When two of the same fruits touch, they merge into a larger fruit</li>
        <li>Plan your drops to create chain reactions and free up space</li>
      ...
      <ul>
        ...
        <li><strong>Physics-Based Fun:</strong> Strategic placement makes a big difference as fruits bounce and slide</li>
        <li><strong>Cross-Platform:</strong> Play <strong>Watermelon Game</strong> on desktop, tablet, or phone without downloading</li>
      ...
      <ol>
        ...
        <li><strong>Use Space Wisely:</strong> Leave room on the sides to drop smaller fruits later.</li>
        <li><strong>Practice Patience:</strong> Rushing will fill your container quickly and end your run!</li>
...

    {
      ...
      seo: {
        title: 'Funny Cubes 2048 - Hilarious Cube Merge Puzzle Online',
        description: 'Play Funny Cubes 2048, the funniest cube-merging puzzle game with hilarious animations and number combos. Slide, merge, and laugh your way to 2048!',
        keywords: 'funny cubes 2048, 2048 merge game, cube puzzle, merge numbers, hilarious puzzle game'
      },
      category: ['merge-games'],
      imageUrl: '/images/game-07.webp',
      imageAlt: 'Funny Cubes 2048 – Hilarious Cubes, Serious Merges',
      ...
      <ul>
        <li>Swipe in four directions to move all cubes at once</li>
        <li>Merge matching numbers to form bigger cubes</li>
        <li>Reach 2048 to unlock the grand finale animation</li>
      ...
      <ul>
        ...
        <li><strong>Colorful & Cartoonish Style:</strong> A vibrant board full of life and chaos</li>
        <li><strong>Instant Gameplay:</strong> <strong>Funny Cubes 2048</strong> is browser-based—no downloads, no delays</li>
      ...
      <ol>
        ...
        <li><strong>Watch the Corners:</strong> Build your highest cube in a corner for stability</li>
        <li><strong>Stay Calm When It’s Crowded:</strong> <strong>Funny Cubes 2048</strong> rewards clever comebacks</li>
...

    {
      ...
      title: 'Number Merge',
      time: '2025-06-30',
      addressBar: 'number-merge',
      seo: {
        title: 'Number Merge - Addictive Number Puzzle Game Online',
        description: 'Play Number Merge, the ultimate brain-boosting number puzzle game. Swipe, combine, and build massive numbers in this relaxing and addictive merge game!',
        keywords: 'number merge, merge game, number puzzle, brain game, merge numbers'
      },
      category: ['merge-games'],
      ...
      <ul>
        <li>Swipe the grid in any direction</li>
        <li>Merge matching numbers to create bigger ones</li>
        <li>Plan your moves to avoid running out of space</li>
      ...
      <ul>
        ...
        <li><strong>Relaxing Soundtrack:</strong> Calm music to accompany your merges</li>
        <li><strong>Instant Play:</strong> No downloads, no logins—just click and play <strong>Number Merge</strong></li>
      ...
      <ol>
        ...
        <li><strong>Keep It Clean:</strong> Avoid cluttered centers; open space is your ally</li>
        <li><strong>Stay Calm:</strong> <strong>Number Merge</strong> rewards patience and clarity</li>
...

    {
      ...
      seo: {
        title: '2048 Italian Brainrot - Chaotic Puzzle Romance of Numbers',
        description: 'Play 2048 Italian Brainrot, a chaotic number merging puzzle with dramatic flair. Swipe your way to 2048 in a whirlwind of logic, passion, and absurdity!',
        keywords: '2048 italian brainrot, merge game, puzzle game, italian logic, chaotic 2048, number romance'
      },
      category: ['merge-games', 'italian-brainrot-games'],
      imageUrl: '/images/game-09.webp',
      imageAlt: '2048 Italian Brainrot – Quando la matematica incontra il dramma',
      ...
      <ul>
        <li>Swipe tiles in any direction (up, down, left, right)</li>
        <li>Combine two matching numbers to merge</li>
        <li>Plan carefully—or don’t. This is <strong>2048 Italian Brainrot</strong></li>
      ...
      <ul>
        ...
        <li><strong>Authentic Brainrot Flavor:</strong> Inspired by TikTok memes, Italian soap operas, and mozzarella logic</li>
        <li><strong>Cross-Device Play:</strong> Works on all devices—play it on your phone while ignoring real responsibilities</li>
      ...
      <ol>
        ...
        <li><strong>Don’t panic:</strong> Even when it feels like everything is collapsing (because it is)</li>
        <li><strong>Swipe with purpose:</strong> Or just swipe. We don’t judge.</li>
...

    {
      ...
      time: '2025-06-30',
      addressBar: 'fish-eat-getting-big',
      seo: {
        title: 'Fish Eat Getting Big - Fun Ocean Survival Game Online',
        description: 'Play Fish Eat Getting Big, a thrilling ocean survival game. Eat smaller fish, grow bigger, and rule the sea in this addictive underwater adventure!',
        keywords: 'fish eat getting big, fish game, eat and grow, ocean survival, fish survival game'
      },
      category: ['merge-games'],
      ...
      <ul>
        <li>Move your fish with keyboard or touch controls</li>
        <li>Eat fish smaller than you to grow</li>
      ...
      <ul>
        ...
        <li><strong>Easy Controls:</strong> Tap or use arrows to guide your fish</li>
        <li><strong>Fast-Paced Action:</strong> Constant danger and opportunity keeps you on edge</li>
      ...
      <ol>
        ...
        <li><strong>Use Speed Wisely:</strong> Escape fast, but don’t waste energy</li>
        <li><strong>Target Schools:</strong> Lots of tiny fish = fast growth</li>
...

    {
      ...
      title: 'Merge Combo',
      time: '2025-06-30',
      addressBar: 'merge-combo',
      seo: {
        title: 'Merge Combo - Ultimate Number Combo Puzzle Game',
        description: 'Play Merge Combo, a fast-paced and satisfying number merging game. Combine tiles, build epic combos, and climb the leaderboard in this addicting puzzle!',
        keywords: 'merge combo, number merge game, puzzle game, combo game, tile merge'
      },
      category: ['merge-games'],
      imageUrl: '/images/game-11.webp',
      imageAlt: 'Merge Combo – Explosive Tile-Merging Fun',
      iframeUrl: 'https://merge-combo.games.playgama.com/cm4ucthtb000sxa0er8cd6v69/index.html?platform_id=playgama',
      isHome: true,
      isFella: true,
      isDetails: true,
      detailsHtml: `
      ...
      <ul>
        ...
        <li>Match 3 or more of the same number to merge</li>
        <li>Chain merges together to trigger epic combos</li>
      ...
      <ul>
        ...
        <li><strong>Colorful Graphics:</strong> Bright and clear visual design with smooth effects</li>
        <li><strong>Instant Play:</strong> No downloads—just click and enjoy <strong>Merge Combo</strong></li>
      ...
      <ol>
        ...
        <li><strong>Work the Corners:</strong> Keep high numbers organized near edges</li>
        <li><strong>Leave Space:</strong> Keep open tiles available for bigger plays</li>
...

    {
      ...
      seo: {
        title: 'Italian Brainrot: Puzzle & Battle - Absurd Match & Fight Chaos',
        description: 'Play Italian Brainrot: Puzzle & Battle – the most chaotic, dramatic, and hilarious puzzle-fighting hybrid. Swipe tiles, scream Italian, and win love & war!',
        keywords: 'italian brainrot puzzle battle, italian puzzle game, brainrot battle, match fight chaos, meme puzzle game'
      },
      ...
      <ul>
        <li>Match 3+ tiles to gain power</li>
        <li>Trigger unique Brainrot attacks when meters fill</li>
        <li>Use logic, instinct, and theatrical chaos to defeat your rival</li>
      ...
      <ul>
        ...
        <li><strong>Brainrot Power-Ups:</strong> “Spaghetti Storm,” “Mamma Shield,” and more</li>
        <li><strong>Multiplayer Mayhem:</strong> Challenge friends to the most melodramatic battle ever</li>
      ...
      <ol>
        ...
        <li><strong>Combo Builds Drama:</strong> Like real life, longer arguments have more impact</li>
        <li><strong>Use Brainrot Skills Wisely:</strong> “Lasagna Launch” is not to be wasted</li>
...

    {
      ...
      seo: {
        title: 'Italian Brainrot Bike Rush - Chaotic Meme Racing Game',
        description: 'Play Italian Brainrot Bike Rush, the most unhinged bike racing game filled with espresso-fueled chaos, flying lasagna, and dramatic Italian brainrot energy!',
        keywords: 'italian brainrot bike rush, italian bike racing, meme racer, chaotic game, brainrot racing game'
      },
      category: ['italian-brainrot-games'],
      imageUrl: '/images/game-13.webp',
      imageAlt: 'Italian Brainrot Bike Rush – Race Like a Drama Queen',
      iframeUrl: 'https://files.twoplayergames.org/files/games/h1/italian-brainrot-bike-rush-v01f/index.html',
      isHome: true,
      isFella: true,
      isDetails: true,
      detailsHtml: `
      ...
      <ul>
        <li>Hold to accelerate your bike</li>
        <li>Swipe left/right to dodge pasta trucks and drama</li>
        <li>Grab espresso power-ups to boost brainrot</li>
        <li>Unlock new characters like “Nonno Drift” or “Giulia the Chaos Queen”</li>
      ...
      <ul>
        ...
        <li><strong>Brainrot Cast:</strong> Unlock bikers like Vito, Bianca, Nonna Rosa, and The Cousin You Don’t Talk About</li>
        <li><strong>Beautiful Italian Brainrot Locations:</strong> From spaghetti fields to the Vatican racetrack</li>
      ...
      <ol>
        ...
        <li><strong>Use drama wisely:</strong> Save your “Mamma Mia Combo” for crowded traffic</li>
        <li><strong>Unlock characters:</strong> Each has unique rage boosts and chaotic bonuses</li>
...

    {
      ...
      seo: {
        title: 'Italian Brainrot Quiz - The Most Chaotic Trivia Ever',
        description: 'Play Italian Brainrot Quiz, the unhinged trivia game full of drama, memes, and mozzarella-fueled madness. Test your knowledge and your patience!',
        keywords: 'italian brainrot quiz, brainrot trivia, chaotic quiz game, meme quiz, italian nonsense game'
      },
      category: ['italian-brainrot-games'],
      ...
      <ul>
        <li>Read each ridiculous question carefully (or don’t)</li>
        <li>Choose one of four chaotic answers</li>
        <li>Earn points for speed, accuracy, and unfiltered brainrot</li>
      ...
      <ul>
        ...
        <li><strong>Multiple Outcomes:</strong> Wrong answers sometimes unlock secret bonus brainrot</li>
        <li><strong>Cross-Device Play:</strong> Works great on phone, tablet, or ancient Roman tablet (not guaranteed)</li>
      ...
      <ol>
        ...
        <li><strong>Embrace the Absurd:</strong> Sometimes “Meatball Renaissance” *is* the correct answer</li>
        <li><strong>Try Every Path:</strong> Secret joke endings await the most unhinged choices</li>
...

    {
      ...
      seo: {
        title: 'Italian Brainrot Obby Parkour - Chaotic Meme Parkour Adventure',
        description: 'Play Italian Brainrot Obby Parkour, the most dramatic obstacle course filled with pizza platforms, spaghetti traps, and maximum operatic parkour energy!',
        keywords: 'italian brainrot obby parkour, meme parkour game, obstacle run, brainrot jump, italian chaos runner'
      },
      category: ['italian-brainrot-games'],
      imageUrl: '/images/game-15.webp',
      imageAlt: 'Italian Brainrot Obby Parkour – Run, Jump, Scream!',
      iframeUrl: 'https://files.twoplayergames.org/files/games/h1/italian-brainrot-obby-parkour-v01l/index.html',
      isHome: true,
      isFella: true,
      isDetails: true,
      detailsHtml: `
      ...
      <ul>
        <li>Use arrow keys or touch controls to move and jump</li>
        <li>Balance across pasta planks and mozzarella trampolines</li>
        <li>Avoid lasagna lasers and airborne rolling meatballs</li>
      ...
      <ul>
        ...
        <li><strong>Fully Themed Madness:</strong> From the Vatican Rooftop to Venice’s Flooded Kitchen</li>
        <li><strong>Playable Anywhere:</strong> Mobile, tablet, desktop—if it can scream, it can run</li>
      ...
      <ol>
        ...
        <li><strong>Use the Meatball Momentum:</strong> It's physics, but chaotic</li>
        <li><strong>Turn on Sound:</strong> The Nonna voiceovers are half the fun</li>
    ...
    
    {
      ...
      seo: {
        title: 'Tung Tung Sahur Obby - Fun Meme Obstacle Rush Game',
        description: 'Play Tung Tung Sahur Obby, the hilarious obstacle parkour inspired by viral Sahur wake-up memes. Jump, dodge, and survive the festive madness!',
        keywords: 'tung tung sahur obby, sahur game, meme obby, obstacle course, ramadan obby game'
      },
      category: ['italian-brainrot-games'],
      imageUrl: '/images/game-16.webp',
      imageAlt: 'Tung Tung Sahur Obby – Wake Up, It’s Parkour Time!',
      iframeUrl: 'https://html5.gamedistribution.com/rvvASMiM/5663a7467cf441d9b4604a890ed0f1ed/index.html?gd_sdk_referrer_url=https%3A%2F%2Fwww.twoplayergames.org%2Fgame%2Ftung-tung-sahur-obby&gd_zone_config=%253D',
      isHome: true,
      isFella: true,
      isDetails: true,
      detailsHtml: `
      ...
      <ul>
        <li>Tap or press to jump across platforms</li>
        <li>Avoid “noise traps” that send you flying</li>
        <li>Reach the end of each level before the Sahur bell ends</li>
      ...
      <ul>
        ...
        <li><strong>Festive Visuals:</strong> Ramadan lanterns, moonlit rooftops, and sleepy neighbors</li>
        <li><strong>Mobile-Ready:</strong> Play anywhere—no download needed</li>
      ...
      <ol>
        ...
        <li><strong>Use Checkpoints:</strong> Don’t skip them or you’ll regret it at the megaphone bridge</li>
        <li><strong>Play With Sound On:</strong> Trust us, the audio is 50% of the experience</li>
...

    {
      ...
      seo: {
        title: 'Tung Tung Sahur: Clicker - Meme Ramadan Clicker Game',
        description: 'Play Tung Tung Sahur: Clicker, the ultimate Ramadan meme game where you click to wake the whole village! Unlock noise upgrades, megaphones, and spicy chaos!',
        keywords: 'tung tung sahur clicker, sahur clicker game, meme clicker, ramadan clicker, clicker game'
      },
      category: ['italian-brainrot-games'],
      ...
      <ul>
        <li>Click the drum to earn Sahur Points</li>
        <li>Buy upgrades like megaphones, gas cans, or chili-fueled vocals</li>
        <li>Hire NPCs like “Loud Uncle” and “Street Kids Choir”</li>
      ...
      <ul>
        ...
        <li><strong>Crazy Upgrades:</strong> From rusty cans to stadium speakers</li>
        <li><strong>Auto-Clicker Fun:</strong> Hire helpers so you can focus on strategy (or vibes)</li>
      ...
      <ol>
        ...
        <li><strong>Don’t Forget the Special Events:</strong> Watch for the “Spicy Sambal Bonus”</li>
        <li><strong>Play With Sound:</strong> The audio is half the experience!</li>
...

    {
      ...
      imageAlt: 'Bombardino Crocodilo Clicker – Unleash the Reptilian Chaos',
