export const blogData = {
  posts: [
    {
      id: 1,
      addressBar: 'merge-rot-chaos-culture',
      ...
      seo: {
        ...
        description: 'How Merge-Rot transformed the merge game formula into a viral meme machine full of chaos, spaghetti, and brainrot.',
        keywords: 'Merge-Rot, merge games, brainrot games, meme culture, viral mobile games, chaotic gameplay, Merge Fellas'
      },
      content: `
        ...
        <p>Games like <strong>Merge Fellas Italian Brainrot</strong> and <strong>Merge Combo</strong> represent the pinnacle of this nonsense. Merge pasta? Check. Dance animations in slow motion? Check. A fully narrated plot about becoming “the true tomato overlord”? Of course.</p>
        <p>These aren’t bugs. This is design by chaos—and it works.</p>
    
        <h2>Why Merge-Rot Works in Today’s Internet</h2>
        <p>Merge-Rot taps into the current internet culture’s craving for content that’s fast, funny, and absurd. These games are perfect for TikTok clips, stream reactions, and meme edits. No tutorial needed—just drop, merge, laugh, repeat.</p>
    
        <h3>Low Effort, High Reward</h3>
        ...
        <p>As the line between game, meme, and performance art continues to blur, Merge-Rot proves one thing: you don’t need coherence to be fun. You just need two hotdogs and a dream.</p>
      `
    },

    {
      id: 2,
      addressBar: 'merge-rot-internet-takeover',
      ...
      seo: {
        ...
        description: 'Merge-Rot has gone from fringe meme to full-blown cultural force. Discover how chaotic merge games became internet obsessions.',
        keywords: 'Merge-Rot, viral merge games, meme gaming, chaotic mobile games, brainrot culture, Merge Fellas, Merge Combo, meme puzzle games'
      },
      content: `
        ...
        <h3>Minimal Effort, Maximal Effect</h3>
        <p>There’s no steep learning curve. You don’t need to “git gud.” You just need to open the app and enjoy the madness. That accessibility is why Merge-Rot has become a cultural phenomenon—even non-gamers are hooked.</p>
    
        <h2>From Gameplay to Lifestyle: The Merge-Rot Aesthetic</h2>
